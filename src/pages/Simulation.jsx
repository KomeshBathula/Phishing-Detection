    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-12rem)] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <div className="w-10 h-10 border-2 border-cyber-accent border-t-transparent rounded-full animate-spin-slow" />
          <p className="text-cyber-muted text-sm font-mono tracking-widest">INITIALIZING_SIMULATION_CORE...</p>
        </div>
      </div>
    );
  }
